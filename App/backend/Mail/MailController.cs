    ...
    public class MailController
    {
        ...
        public async Task<bool> TourAccepted(Tour tour)
        {
            ...
            var email = new TransactionalEmailBuilder()
                   ...
                   .WithTextPart($"{info.School.SchoolName}, {info.DateOfVisit} tarihli tur kabul edildi.")
        ...
        public async Task<bool> TourCancelled(Tour tour)
        {
            ...
            var email = new TransactionalEmailBuilder()
                   ...
                   .WithTextPart($"{info.School.SchoolName}, {info.DateOfVisit} tarihli tur iptal edildi.")
                   .WithTo(new SendContact(info.SuperVisorMailAddress))
                   .Build();
